...
`add_resource()` set one property (`delimiter`) when data are provided as a CSV file with non-default delimiter, all other properties are assumed to be the default.
