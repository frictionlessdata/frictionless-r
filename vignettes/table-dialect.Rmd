...
When creating a resource from a data frame, `add_resource()` does not set any Table Dialect properties. `write_package()` writes this data frame to a CSV file, but does not set any Table Dialect properties either, since only the defaults are used.
