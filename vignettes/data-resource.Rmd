...
`write_package()` leaves originally included resources as is and write newly added resources as Tabular Data Resources.
...
`write_package()` writes the data frame to a CSV file, add its `path` and remove `data`.
