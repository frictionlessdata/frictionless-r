...
`write_package()` will leave originally included resources as is and write newly added resources as Tabular Data Resources.
...
[`encoding`](https://specs.frictionlessdata.io/data-resource/#optional-properties) (e.g. `"windows-1252"`) is used by `read_resource()` to parse the file. It will default to UTF-8 if no `encoding` is provided or if it cannot be recognized. The returned data frame will always be UTF-8.
