...
`add_properties()` can be used to add (custom) metadata properties to a resource. This can also be done with `add_resource()`, which checks for reserved properties.
