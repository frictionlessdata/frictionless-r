...
`write_package()` writes a package to disk as a `datapackage.json` file. It also writes the resources to CSV files, if those are tabular, referring to an local file or newly created from a data frame. See the function documentation for details.
