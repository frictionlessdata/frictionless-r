...
- All functions now understand a v2 package, resource, dialect or schema, but might not support all v2 features.
...
- `upgrade_package()` can be used to upgrade a package, its resources and schemas from v1 to v2.
