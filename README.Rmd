...
frictionless supports Data Packages using the [v1](https://specs.frictionlessdata.io/) and [v2](https://datapackage.org/) specification. When creating a package, resource or schema, it uses the v2 specification.
